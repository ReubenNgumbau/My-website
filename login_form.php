...
if (isset($_POST["login_user_with_vehicle"])) {
	//this is vehicle list array
	$vehicle_list = $_POST["vehicle_id"];
	//here we are converting array into json format because array cannot be store in cookie
	$json_e = json_encode($vehicle_list);
	//here we are creating cookie and name of cookie is vehicle_list
	setcookie("vehicle_list",$json_e,strtotime("+1 day"),"/","","",TRUE);
